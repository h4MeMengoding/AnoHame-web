...
export const AboutContent = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-4">
      <p className="mb-4">
        <b>AnoHame</b> merupakan platform untuk kalian bisa gunakan untuk
        ...
        terjamin. <b>AnoHame</b> tidak menyediakan tempat untuk menjawab
      ...
      <p className="mb-4">
        <b>AnoHame</b> merupakan projek dengan kode sumber terbuka dan bisa
        dipelajari di{' '}
        <a
      ...
      <Card className="mb-4 p-4 flex justify-between items-center">
        <a
          ...
          className="underline"
        >
          <h3 className="text-xl font-bold tracking-tight">mazipan/AnoHame</h3>
        </a>
        <img
      ...
      <p className="mb-4">
        Untuk terus mendukung <b>AnoHame</b>, kalian bisa mengirimkan dana
      ...
      <p className="mb-4">
        Pertanyaan tentang platform <b>AnoHame</b>, dapat ditujukan ke
