...
export async function generateMetadata({
  ...
  const title = `Lempar pertanyaan anonim ke ${owner?.data?.name} lewat AnoHame`
  const description = `Mulai bertanya anonim ke ${owner?.data?.name} melalui aplikasi AnoHame. Mudah, gratis dan terjamin rahasia.`
