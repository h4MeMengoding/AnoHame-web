...
export const metadata: Metadata = {
  title: 'Eksplor Pengguna di AnoHame',
  alternates: {
    canonical: `${BASEURL}/eksplor`,
  },
  description: 'Eksplor Pengguna di AnoHame dan mulai bertanya dengan anonim',
  openGraph: {
    description:
      'Eksplor Pengguna di AnoHame dan mulai bertanya dengan anonim',
    title: 'Eksplor Pengguna di AnoHame',
  },
  twitter: {
    title: 'Eksplor Pengguna di AnoHame',
