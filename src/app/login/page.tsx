...
import logoSvg from '~/public/logo/AnoHame.svg'

export const metadata: Metadata = {
  title: 'Masuk atau Daftar AnoHame',
  alternates: {
    canonical: `${BASEURL}/login`,
  },
  description:
    'Masuk atau Daftar akun AnoHame. Kumpulkan berbagai pertanyaan dari siapa saja secara anonim',
  openGraph: {
    description:
      'Masuk atau Daftar akun AnoHame. Kumpulkan berbagai pertanyaan dari siapa saja secara anonim',
    title: 'Masuk atau Daftar AnoHame',
      ...
      <Card className="w-full md:w-[350px] min-h-[350px] flex flex-col justify-between items-center gap-6 py-4">
        <Link href="/" className="flex gap-2 items-center mt-4">
          <Image
            ...
            className=""
          />
          <h2 className="font-extrabold text-2xl tracking-tight">AnoHame</h2>
        </Link>
